...
public class JGoban extends JPanel {
    ...
    Image blackImage; //Kí hiệu các quân cờ, X
    Image whiteImage; //Kí hiệu các quân cơ O
    ...
    //kiểm tra xem có đánh được vào vị trí này không
    ...
    //Kiểm tra sự khả dụng của vị trí đánh
    //Nếu được thì set vào
