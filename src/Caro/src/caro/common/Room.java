...
public class Room implements Serializable{
    ...
    static final int NOT5        = 0; //Chưa thắng
    static final int OK5         = 1; //Đã thắng
    ...
    //Vào game, khởi đôngk giá trị các bàn là 25, các ô rỗng
    void NewGame()
    {
    ...
    public Room(int _id) {
        id = _id; //Lấy mã phòng
        lstClientView = new ArrayList<ClientHandler>(); //số người trong phòng
        ...
        //Khởi tạo và kí hiệu các ô xung quanh của 1 điểm
        Dx[0] =  0;  Dy[0] = -1;
        Dx[1] =  1;  Dy[1] = -1;
        Dx[2] =  1;  Dy[2] =  0;
        Dx[3] =  1;  Dy[3] =  1;
    ...
    //Kiểm tra các giá trị màu giống nhau trên 1 hướng cho trước
    ...
    public int Find5Block(int color,int x,int y) {
        ...
        //Đếm các quân giống màu
        ma  = GetSequence(color,x,y,D_UP) + GetSequence(color,x,y,D_DOWN) - 1 ;
    ...
    {
        //phòng con 1 người thì đóng toàn bộ
        if (countAvailable()==1)
        {
            if (client1!=null)
                client1.room = null;
        ...
        else if (countAvailable()==0) //phòng có 2 người, ai thoát trận trước, người đó thua
        {
